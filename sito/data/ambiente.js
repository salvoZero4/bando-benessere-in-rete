...
window.siteContent.environment = {
  ...
  "title": "Ambiente",
  "description": "Il patrimonio naturale di Altavilla Milicia unisce la riserva, il litorale tirrenico e l'impegno quotidiano per un territorio più pulito e consapevole.",
  "reserve": {
    "number": "01",
    "eyebrow": "Area protetta",
    "title": "Riserva Naturale Orientata Pizzo Cane, Pizzo Trigna e Grotta Mazzamuto",
    "paragraphs": [
    ...
    "detailId": "reserve",
    "photo": {
      "label": "Foto della Riserva di Pizzo Cane, Pizzo Trigna e Grotta Mazzamuto",
  ...
  "coast": {
    ...
    "description": "Località balneari riconosciute lungo il litorale, tra calette, ciottoli, sabbia e tratti attrezzati.",
    "emptyMessage": "Nessuna spiaggia disponibile.",
    "items": [
      {
        "type": "Cala naturale",
        "title": "Cala Sciabica",
        "description": "La baia ai piedi di Capo Grosso, conosciuta anche come Torre Normanna o Ombelico di Venere."
      },
      {
        "type": "Spiaggia",
        "title": "Spiaggia Passi",
        "description": "Tratto del litorale locale raggiunto anche dal servizio estivo di collegamento con le spiagge."
      },
      {
        "type": "Lido",
        "title": "Lido La Capannina",
        "description": "Punto balneare attrezzato della costa di Altavilla Milicia, lungo il litorale della SS 113."
      },
      {
        "type": "Spiaggia libera",
        "title": "Spiaggia La Catena",
        "description": "Spiaggia libera in zona Via Consolare, inserita nel tratto costiero di Altavilla Milicia."
      }
    ]
  },
  "sustainability": {
    ...
    "description": "Servizi, volontariato e scuola lavorano insieme per diffondere comportamenti responsabili e proteggere gli spazi comuni.",
    "emptyMessage": "Nessuna iniziativa disponibile.",
    "items": [
      {
        "icon": "recycling",
        "title": "Raccolta differenziata",
        "description": "Separazione di organico, secco, plastica, vetro e carta, servizi per ingombranti e conferimento nei punti di raccolta.",
      ...
      },
      {
        ...
        "description": "Giornate di pulizia degli arenili e sensibilizzazione contro l'abbandono dei rifiuti, con volontari e comunità locale.",
      ...
      },
      {
        ...
        "description": "Progetti dell'Istituto Comprensivo come “Un alunno, un albero”, attività Plastic Free, riciclo e tutela del mare.",
  ...
  "details": {
    "reserve": {
      ...
      "title": "Riserva Naturale Orientata Pizzo Cane, Pizzo Trigna e Grotta Mazzamuto",
      "subtitle": "Un'area protetta tra rilievi, boschi mediterranei, valloni e cavità di interesse naturalistico e archeologico.",
      "content": [
    ...
    "recycling": {
      ...
      "title": "Raccolta differenziata",
      "subtitle": "Indicazioni essenziali per separare correttamente i rifiuti e utilizzare i servizi disponibili sul territorio.",
      "content": [
    ...
    "plastic-free": {
      ...
      "title": "Attività Plastic Free",
      "subtitle": "Giornate di pulizia e sensibilizzazione per proteggere spiagge, mare e spazi condivisi.",
      "content": [
    ...
    "school": {
      ...
      "title": "Educazione ambientale a scuola",
      "subtitle": "Alunni e insegnanti partecipano a progetti dedicati ad alberi, riciclo, riduzione della plastica e tutela del mare.",
      "content": [
  ...
  "search": "ambiente natura riserva pizzo cane pizzo trigna grotta mazzamuto spiagge cala sciabica passi capannina catena sostenibilità raccolta differenziata plastic free educazione ambientale scuola"
};
